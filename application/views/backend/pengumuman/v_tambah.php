<div class="content-wrapper">
    <section class="content-header">
        <h1>
            PENGUMUMAN
            <small>Tulis pengumuman Baru</small>
        </h1>
    </section>
    ...
    <section class="content">
        ...
        <form method="post" action="<?php echo base_url('backend/pengumuman/store') ?>" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-9">
                        ...
                        <div class="box-body">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <label>Judul</label>
                                    <input type="text" name="judul" class="form-control" placeholder="Masukkan judul pengumuman.." value="<?php echo set_value('judul'); ?>">
                                    <br />
